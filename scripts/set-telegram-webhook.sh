...
commands_en='[{"command":"start","description":"Start and choose a country"},{"command":"battle","description":"Launch an unlimited operation"},{"command":"daily","description":"Claim Credits and streak bonus"},{"command":"army","description":"Build and select combat groups"},{"command":"shop","description":"Buy or craft equipment"},{"command":"upgrade","description":"Upgrade owned equipment"},{"command":"profile","description":"Progress, record, and resources"},{"command":"front","description":"Weekly matchup, timer, and result"},{"command":"contribute","description":"Manage groups on the weekly front"},{"command":"rankings","description":"Alliance and player ratings"},{"command":"guide","description":"Game rules by section"},{"command":"country","description":"Browse or search countries"},{"command":"language","description":"Change language"},{"command":"nickname","description":"Choose or change nickname"},{"command":"settings","description":"Language and profile settings"},{"command":"help","description":"Command help"}]'
