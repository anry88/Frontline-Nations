...
commands_en='[{"command":"start","description":"Start and choose a country"},{"command":"battle","description":"Launch an unlimited operation"},{"command":"daily","description":"Claim Credits and streak bonus"},{"command":"army","description":"Build and select combat groups"},{"command":"shop","description":"Buy or craft equipment"},{"command":"upgrade","description":"Upgrade owned equipment"},{"command":"profile","description":"Progress, record, and resources"},{"command":"front","description":"Weekly matchup, timer, and result"},{"command":"contribute","description":"Commit equipment to the weekly front"},{"command":"country","description":"Browse or search countries"},{"command":"language","description":"Change language"},{"command":"nickname","description":"Choose or change nickname"},{"command":"settings","description":"Language and profile settings"},{"command":"help","description":"Command help"}]'
commands_ru='[{"command":"start","description":"Начать игру и выбрать страну"},{"command":"battle","description":"Начать бой без суточного лимита"},{"command":"daily","description":"Получить Credits и бонус серии"},{"command":"army","description":"Собрать и выбрать боевую группу"},{"command":"shop","description":"Купить или произвести технику"},{"command":"upgrade","description":"Прокачать свою технику"},{"command":"profile","description":"Прогресс, статистика и ресурсы"},{"command":"front","description":"Матч недели, таймер и результат"},{"command":"contribute","description":"Отправить технику на недельный фронт"},{"command":"country","description":"Каталог и поиск стран"},{"command":"language","description":"Сменить язык"},{"command":"nickname","description":"Выбрать или сменить ник"},{"command":"settings","description":"Язык и настройки профиля"},{"command":"help","description":"Справка по командам"}]'
commands_es='[{"command":"start","description":"Iniciar y elegir país"},{"command":"battle","description":"Iniciar una operación sin límite"},{"command":"daily","description":"Recibir Credits y bono diario"},{"command":"army","description":"Preparar grupos de combate"},{"command":"shop","description":"Comprar o fabricar equipo"},{"command":"upgrade","description":"Mejorar el equipo"},{"command":"profile","description":"Progreso y recursos"},{"command":"front","description":"Batalla semanal"},{"command":"contribute","description":"Enviar equipo al frente"},{"command":"country","description":"Buscar países"},{"command":"language","description":"Cambiar idioma"},{"command":"nickname","description":"Cambiar apodo"},{"command":"settings","description":"Ajustes del perfil"},{"command":"help","description":"Ayuda"}]'
commands_pt='[{"command":"start","description":"Iniciar e escolher país"},{"command":"battle","description":"Iniciar uma operação sem limite"},{"command":"daily","description":"Receber Credits e bônus diário"},{"command":"army","description":"Montar grupos de combate"},{"command":"shop","description":"Comprar ou produzir equipamento"},{"command":"upgrade","description":"Melhorar equipamento"},{"command":"profile","description":"Progresso e recursos"},{"command":"front","description":"Batalha semanal"},{"command":"contribute","description":"Enviar equipamento à frente"},{"command":"country","description":"Buscar países"},{"command":"language","description":"Alterar idioma"},{"command":"nickname","description":"Alterar apelido"},{"command":"settings","description":"Ajustes do perfil"},{"command":"help","description":"Ajuda"}]'
commands_ar='[{"command":"start","description":"البدء واختيار البلد"},{"command":"battle","description":"بدء عملية بلا حد يومي"},{"command":"daily","description":"استلام Credits ومكافأة السلسلة"},{"command":"army","description":"إعداد مجموعات القتال"},{"command":"shop","description":"شراء أو تصنيع المعدات"},{"command":"upgrade","description":"ترقية المعدات"},{"command":"profile","description":"التقدم والموارد"},{"command":"front","description":"المعركة الأسبوعية"},{"command":"contribute","description":"إرسال المعدات إلى الجبهة"},{"command":"country","description":"البحث عن البلدان"},{"command":"language","description":"تغيير اللغة"},{"command":"nickname","description":"تغيير الاسم"},{"command":"settings","description":"إعدادات الملف"},{"command":"help","description":"المساعدة"}]'
commands_id='[{"command":"start","description":"Mulai dan pilih negara"},{"command":"battle","description":"Mulai operasi tanpa batas harian"},{"command":"daily","description":"Ambil Credits dan bonus rentetan"},{"command":"army","description":"Susun grup tempur"},{"command":"shop","description":"Beli atau rakit unit"},{"command":"upgrade","description":"Tingkatkan unit"},{"command":"profile","description":"Progres dan sumber daya"},{"command":"front","description":"Pertempuran mingguan"},{"command":"contribute","description":"Kirim unit ke front"},{"command":"country","description":"Cari negara"},{"command":"language","description":"Ganti bahasa"},{"command":"nickname","description":"Ganti nama"},{"command":"settings","description":"Pengaturan profil"},{"command":"help","description":"Bantuan"}]'
commands_hi='[{"command":"start","description":"शुरू करें और देश चुनें"},{"command":"battle","description":"बिना दैनिक सीमा अभियान शुरू करें"},{"command":"daily","description":"Credits और सिलसिला बोनस पाएँ"},{"command":"army","description":"युद्ध समूह बनाएँ"},{"command":"shop","description":"उपकरण खरीदें या बनाएँ"},{"command":"upgrade","description":"उपकरण उन्नत करें"},{"command":"profile","description":"प्रगति और संसाधन"},{"command":"front","description":"साप्ताहिक युद्ध"},{"command":"contribute","description":"मोर्चे पर उपकरण भेजें"},{"command":"country","description":"देश खोजें"},{"command":"language","description":"भाषा बदलें"},{"command":"nickname","description":"नाम बदलें"},{"command":"settings","description":"प्रोफ़ाइल सेटिंग"},{"command":"help","description":"सहायता"}]'
commands_tr='[{"command":"start","description":"Başla ve ülke seç"},{"command":"battle","description":"Günlük sınırsız operasyon başlat"},{"command":"daily","description":"Credits ve seri bonusunu al"},{"command":"army","description":"Muharebe grupları kur"},{"command":"shop","description":"Teçhizat satın al veya üret"},{"command":"upgrade","description":"Teçhizatı yükselt"},{"command":"profile","description":"İlerleme ve kaynaklar"},{"command":"front","description":"Haftalık savaş"},{"command":"contribute","description":"Cepheye teçhizat gönder"},{"command":"country","description":"Ülke ara"},{"command":"language","description":"Dili değiştir"},{"command":"nickname","description":"Adı değiştir"},{"command":"settings","description":"Profil ayarları"},{"command":"help","description":"Yardım"}]'
