...
4. The selected operation resolves to a versioned 9×12 odd-row offset sector map. The bot sends its immutable 1,536×1,536 PNG assembled from generated full-bleed hex terrain and objective blocks; the upright rectangular coordinates, connected roads, unique edge entries, and objectives match the server map snapshot.
