...
object GameGuide {
    ...
    private val pages = listOf(
        ...
        LocalizedPage(
            p("Weekly front", "The alliance battle resolves Sunday at 15:00 Belgrade time. In /contribute you may send any or all three distinct groups, choosing an entry and tactic for each. Sent equipment is unavailable elsewhere. Withdraw it before the lock, or wait for survivors to return after battle."),
            p("Недельный фронт", "Битва стран проходит в воскресенье в 15:00 по Белграду. Через /contribute можно отправить любой из трёх отрядов или все три, выбрав каждому вход и тактику. Отправленная техника недоступна в других боях. До блокировки её можно отозвать; после боя вернутся выжившие."),
            p("Frente semanal", "La batalla se resuelve el domingo a las 15:00 de Belgrado. En /contribute envía hasta tres grupos con entrada y táctica. Puedes retirarlos antes del bloqueo."),
            p("Frente semanal", "A batalha ocorre domingo às 15:00 de Belgrado. Em /contribute envie até três grupos com entrada e tática. É possível retirá-los antes do bloqueio."),
            p("الجبهة الأسبوعية", "تُحسم المعركة الأحد 15:00 بتوقيت بلغراد. عبر /contribute أرسل حتى ثلاث مجموعات واختر المدخل والتكتيك. يمكن سحبها قبل الإغلاق."),
            p("Front mingguan", "Pertempuran selesai Minggu 15.00 waktu Beograd. Lewat /contribute kirim hingga tiga grup, pilih pintu dan taktik, atau tarik sebelum terkunci."),
            p("साप्ताहिक मोर्चा", "युद्ध रविवार 15:00 बेलग्रेड समय पर होता है। /contribute से तीन तक दल, प्रवेश और रणनीति चुनकर भेजें; लॉक से पहले वापस बुला सकते हैं।"),
            p("Haftalık cephe", "Savaş pazar 15.00 Belgrad saatinde çözülür. /contribute ile üç gruba kadar giriş ve taktik seçerek gönder; kilitten önce geri çekebilirsin."),
        ),
        LocalizedPage(
