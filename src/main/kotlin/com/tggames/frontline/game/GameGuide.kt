...
object GameGuide {
    ...
    private val pages = listOf(
        ...
        LocalizedPage(
            p("Score and rewards", "Weekly score comes from held objectives, destroyed enemy force and half of surviving allied force. Countries start at 10,000 rating: winners add their score, while losers lose 2–15% according to the score deficit. Contributors receive team and personal rewards. The winner gains ×1.2 Credits, XP and Materials for seven days. See /rankings."),
            p("Очки и награды", "Недельный счёт складывается из удерживаемых объектов, уничтоженной техники и половины выжившей силы. Страны начинают с рейтинга 10 000: победитель добавляет свой счёт, проигравший теряет 2–15% в зависимости от разницы счёта. Участники получают общую и личную награду, победитель — ×1,2 Credits, XP и Материалов на семь дней. /rankings"),
            p("Puntos", "El frente puntúa objetivos, enemigos destruidos y la mitad de la fuerza aliada superviviente. Los países empiezan con 10.000: el ganador suma su puntuación y el perdedor pierde 2–15% según la diferencia. El ganador obtiene ×1,2 Credits, XP y Materiales durante siete días. /rankings"),
            p("Pontos", "O front pontua objetivos, inimigos destruídos e metade da força aliada sobrevivente. Países começam com 10.000: o vencedor soma a pontuação e o perdedor perde 2–15% conforme a diferença. O vencedor recebe ×1,2 Credits, XP e Materiais por sete dias. /rankings"),
            p("النقاط", "تحسب الجبهة الأهداف والقوة المدمرة ونصف القوة الباقية. تبدأ الدول بتصنيف 10,000؛ يضيف الفائز نقاطه ويخسر المهزوم 2–15% حسب فارق النتيجة. يحصل الفائز على ×1.2 Credits وXP والمواد لسبعة أيام. /rankings"),
            p("Skor", "Skor front berasal dari sasaran, musuh hancur, dan separuh kekuatan yang tersisa. Negara mulai dari 10.000: pemenang menambah skor, pihak kalah kehilangan 2–15% sesuai selisih. Pemenang mendapat ×1,2 Credits, XP, dan Material selama tujuh hari. /rankings"),
            p("अंक", "मोर्चे का स्कोर लक्ष्य, नष्ट शत्रु और बची शक्ति के आधे से बनता है। देश 10,000 रेटिंग से शुरू करते हैं: विजेता अपना स्कोर जोड़ता है और हारने वाला अंतर के अनुसार 2–15% खोता है। विजेता को सात दिन ×1.2 Credits, XP और सामग्री मिलती है। /rankings"),
            p("Puan", "Cephe puanı hedefler, imha edilen düşman ve kalan gücün yarısından oluşur. Ülkeler 10.000 ile başlar; kazanan puanını ekler, kaybeden farka göre %2–15 kaybeder. Kazanan yedi gün ×1,2 Credits, XP ve Malzeme alır. /rankings"),
        ),
    )
}
