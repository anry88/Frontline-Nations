...
Until a commander finishes more than one personal battle, the profile and first result explicitly point to `/daily` for recurring Credits and `/shop` for equipment purchases.
